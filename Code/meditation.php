...
<li id="1956553309-menu-item-2420" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3253 current_page_item active no-mega-menu" ><a href="meditation.php" class=""><i class="fa fa-music"></i><b> MEDITATION</b></a>
  ...
  <div class="container">
      <div class="row">
          ...
          <div id="mobile-logo" class="logo">
                                ...
                                " alt="AM" style=" width: 150px" srcset="" class="img-responsive"/></a>
                            </a>
                                  </div>
...
<li id="menu-item-3255" class="menu-item menu-item-type-post_type menu-item-object-page  no-mega-menu "><a href="meditation.php" class=""><i class="fa fa-music"></i><b> MEDITATION</b></a>
<!--<ul class="sub-menu">
...
<div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-source="gallery" style="background:#e3edf6;padding:0px;">
  ...
  <div class="w3-content w3-container w3-padding-128">
  <center><p align="justify">
<font size="3.9"><b><font color="#C71585">"MEDITATION</b> <b>is the secret of all "GROWTH" in spiritual life and Knowledge.</b></b> <b>It is </b><b>tongue of the soul and </b><b>language of the spirit."</b></font></b></font></center>
 <p align="justify"><b><font color="black">The nature of the music experience inherently provides creative energy that is usually lost in the hospital shuffle. Music not only enriches the quality of one's life but may help provide the impetus to live. Music therapy is particularly adaptive to all human conditions-even a comatose patient at the end stage of life may benefit from a listening or guided imagery activity Music has the capacity to energize or relax, to promote thought or distraction. Hospital life need not be a stagnant passing of time; new and moving expressions can originate at the bedside. The patient, regardless of disease stage, is a vital psychodynamic being. </b></font></p>
  <p align="justify">
<h1><b><center><font size="5"><font color="#f44183"><i class="fa fa-music w3-center"> THERAPY SESSIONS</i></font></font></center></b></h1>


<div class="row">
  <div class="column">
    <img src="images1/9.jpg" class="w3-round w3-image  w3-hover-opacity-off" alt="Snow" style="width:100%">
    <h6 align="middle"><br><i class="fa fa-map-marker w3-center"> AT...</i><br></h6>
  </div>
  <div class="column">
    <img src="pics/11.jpg" class="w3-round w3-image  w3-hover-opacity-off" alt="Forest" style="width:100%">
    <h6 align="middle"><br><i class="fa fa-map-marker"> AT...</i><br></h6>
  </div>
  <div class="column">
    <img src="images1/23.jpg"  class="w3-round w3-image  w3-hover-opacity-off" alt="Mountains" style="width:100%">
    <h6 align="middle"><br><i class="fa fa-map-marker"> AT PANDHARPUR</i><br></h6>
  </div>
</div>

  <div class="w3-content w3-container w3-padding-16">
<center><p align="justify"><b><font color="black">This music therapy session served to help "break the ice" on some very difficult issues, such as recurrent separations from her friends due to friend. These friends usually responds with appropriate sadness and on his own initiative sought out support from staffmembers whom he had previously confided hospitalization, traumatic departure from a previously carefreelifestyle, and an initial confrontation on a conscious and verbalized level of the possible eventuality of her own death  was soon discharged as an out-patient.
</p></b></div></center></font>
</div>
...
<footer class="site-footer no-separator">
        ...
        <div class="col-xs-12 col-sm-6 col-lg-3">
           <div id="ttbase_framework_contact_widget-2" class="widget widget_ttbase_framework_contact_widget">
            <div class="clearfix visible-sm-block visible-md-block"></div>
                          <div id="ttbase_framework_opening_hours_widget-2" class="widget widget-opening-hours"><h4 class="title">Opening Hours</h4><div class="opening-hours"><ul><li class="weekday">Monday<span class="right">07:00-17:00</span></li><li class="weekday">Tuesday<span class="right">07:00-17:00</span></li><li class="weekday">Wednesday<span class="right">07:00-17:00</span></li><li class="weekday">Thursday<span class="right">07:00-17:00</span></li><li class="weekday">Friday<span class="right">07:00-17:00</span></li><li class="weekday">Saturday<span class="right">07:00-17:00</span></li><li class="weekday">Sunday<span class="right">07:00-17:00</span></li></ul></div></div>                              
              </div>
            </div>
        </div>
    </div>
