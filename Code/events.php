...
<!-- normal size logo -->
    <div class="logo-wrapper">
        ...
        " id="site-logo" title="AM" rel="home">
                            <img src="images/logo.png" alt="" style=" width: 200px;
                            "; srcset="" class="img-responsive"  />
                    </a>
    </div>
                <!-- Menu -->
  ...
  <div class="container">
      <div class="row">
          ...
          <div id="mobile-logo" class="logo">
                                ...
                                <br><img src="images/logo.png" alt="AM" style=" width: 150px" srcset="" class="img-responsive"/></a>
                            </a></br>
                                  </div>
...
<!--<ul class="sub-menu">
 ...
 <li id="menu-item-3202" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3253 current_page_item active no-mega-menu"><a href="events.php" class=""><i class="fa fa-music"></i><b> EVENTS </b></a></li>
...
<div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-source="gallery" style="background:#e3edf6;padding:0px;">
 ...
 <p align="justify"><p class="w3-content w3-container w3-padding-32">
 <font size="4"><em><b><b><font color="#C71585"><center>"The ultimate victory  
 </b> in competition is derived from the inner satisfaction <b>of knowing that you have done your best </b></b> <b>and that you have gotten the most</b><b>out of what you had to give."</b><b></b></em></font></b></font></center><br>
  <center><p align="justify"><b><font color="black">A platform for those who have hidden talent in themselves such as singing, dancing and drawing. You are welcome to showcase your talent at "SWAR RANG 2018"</b></p></center></font></p>
<style>
.column {
  float: left;
  width: 25%;
...
<div class="row text-center text-lg-left">
  <p align="justify">
<h1><b><center><font size="6"><font color="#f44183">COMPETITIONS</font></font></center></b></h1>
</p>
<div class="col-lg-3 col-md-4 col-xs-6">
          <a href="#" class="d-block mb-4 h-100">
 
  <img src="images/33.jpg" class="w3-round w3-image  w3-hover-opacity-off" alt=""  style="width:100%">
    <h6 align="middle"><br><i class="fa fa-microphone w3-center"> SINGING </i><br></h6>
  </div>
</a>

  <div class="col-lg-3 col-md-4 col-xs-6">
          <a href="#" class="d-block mb-4 h-100">
    <img src="images/34.jpg" class="w3-round w3-image  w3-hover-opacity-off" alt="" style="width:100%">
    <h6 align="middle"><br><i class="fa fa-play"> DANCING </i><br></h6>
  </a>
  </div>
   <div class="col-lg-3 col-md-4 col-xs-6">
          <a href="#" class="d-block mb-4 h-100">
    <img src="images/41.jpg" class="w3-round w3-image  w3-hover-opacity-off" alt="" style="width:100%">
    <h6 align="middle"><br><i class="fa fa-play"> INSTRUMENTAL </i><br></h6>
  </a>
  </div>
  <div class="col-lg-3 col-md-4 col-xs-6">
          <a href="#" class="d-block mb-4 h-100">
    <img src="images/35.jpg"  class="w3-round w3-image  w3-hover-opacity-off" alt="" style="width:100%">
    <h6 align="middle"><br><i class="fa fa-paint-brush"> DRAWING </i><br></h6>
  </a>
  </div>
</div>
...
<div class="centered"></div>
  ...
  <font size="4"><b><input type="checkbox" name="" value=""/><a href="terms.php">I Accept Terms and Conditions</font></b><br></a>
...
<div class="centered"></div>
<div role="form" class="wpcf7" id="wpcf7-f3310-p1764-o2" lang="en-US" dir="ltr">
...
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f3310-p1764-o2" />
...
<div class="col-12 col-sm-6 col-md-8">
  <form action="https://goo.gl/forms/lbBwrUwHcsEHHiAy2" class="wpcf7-form wpcf7-style-1" enctype="multipart/form-data" novalidate="novalidate">
    <center><input type="submit" value="ENROLL NOW" class="wpcf7-form-control btn btn-primary btn-lg btn btn-primary style-3" /></center>
  </form>
  </div>
      <!--<div class="col-12 col-sm-6 col-md-6">
        <form action="https://goo.gl/forms/plNUACoBVDGJMfpY2" class="wpcf7-form wpcf7-style-1" enctype="multipart/form-data" novalidate="novalidate">
    <center><input type="submit" value="SIGN UP(for school/college students)" class="wpcf7-form-control btn btn-primary btn-lg btn btn-primary style-3" /></center>
  </form>
  </div>-->
</div>
</div>
           ...
           <!-- <div class="col-xs-12 col-sm-6 col-lg-3">
            ...
            <div class="contact-widget-email">
              <span class="fa fa-envelope"></span>
                  <span>vikram_sangeet@yahoo.co.in</b></span>
                          </div>    
                </div>
            </div>                             
        </div>-->
