...
<script>
   ...
   setInterval(function(){ $('#myModal').modal('show'); }, 3000);
    }); 
</script>
</head>
<body>
...
<!--end here-->
<title>Art Meditation- Contact US</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
...
<!-- normal size logo -->
    <div class="logo-wrapper">
        <a href="index.php" id="site-logo" title="AM" rel="home">
                            <img src="images/logo.png" alt="AM" style=" width: 150px"; srcset="" class="img-responsive"  />
                    </a>
    </div>
                <!-- Menu -->
...
<li id="2104552354-menu-item-3255" class=" menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3253 current_page_item active no-mega-menu" ><a href="contact.php" class=""><i class="fa fa-envelope"></i><b> CONTACT US</b></a></li>
<?php
if (login_check($mysqli) == true) {
    $logged = 'in';?>
  ...
  <div class="container">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="menu-main-container"><ul id="mobile-nav" class="menu"><li id="menu-item-2923" class="menu-item menu-item-type-post_type menu-item-object-page  no-mega-menu " class=""><i class="fa fa-home"></i><b> HOME </b></a>
...
<li id="menu-item-2420" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3253 current_page_item active no-mega-menu"><a href="contact.php" class=""><i class="fa fa-envelope"></i><b> CONTACT US</b></a></li>
<?php
if (login_check($mysqli) == true) {
    $logged = 'in';?>
...
<div class="w3-content w3-container w3-padding-128" id="contact">
  <p class="w3-center w3-container w3-padding-64"><font size="8"><font color="black"><em><b>I'd loved your feedback!</b></em></font></font></p>

  <div class="w3-row w3-padding-32 w3-section">
    <div class="w4-col m3 w4-container">
      <!-- Add Google Maps -->
      
<div class="mapouter"><div class="gmap_canvas"><iframe width="1200" height="300" id="gmap_canvas" src="https://maps.google.com/maps?q=kharghar%2C%20Navi%20Mumbai&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href=""></a></div><style>.mapouter{text-align:right;height:300px;width:500px;}.gmap_canvas {overflow:hidden;background:none!important;height:300px;width:800px;}</style></div>

    </div>
    <div class="w3-col m16 w3-container w3-section">
      <div class="w3-large w3-margin-bottom"><br>

        <i class="fa fa-map-marker fa-fw w4-hover-text-black w6-xlarge w6-margin-right"></i>Kharghar, NAVI MUMBAI,INDIA<br>
        <i class="fa fa-phone fa-fw w4-hover-text-black w6-xlarge w6-margin-right"></i> Phone: +91 98213 66041<br>
       <i class="fa fa-envelope fa-fw w4-hover-text-black w6-xlarge w6-margin-right"></i> Email: vikram_sangeet@yahoo.co.in<br><br>
      </div>  
      </div>
    <style>
...
<p><b>Swing by for a cup of coffee <i class="fa fa-coffee"></i> or leave me a note <i class="fa fa-sticky-note-o" aria-hidden="true"></i></b></p>
...
<div class="w3-half">
    ...
    <textarea type="text" id="comment" name="comment" placeholder="Comment" style="height:200px"></textarea>
...
<footer class="site-footer no-separator">
        ...
        <div class="ttbase-image-widget" >
                    <img class="img-responsive" width= 80px; src="images/logo.png" alt=""/>
                  </div>
        ...
        <div class="contact-widget  clearfix">
            ...
            <div class="contact-widget-description clearfix">
              <b>If you have any feedback or questions do not hesitate to contact us           </b></div>
...
Kharghar, NAVI MUMBAI,INDIA</b></p>
            ...
            <div class="contact-widget-email">
              <span class="fa fa-envelope"></span>
                              <span>
                  <b>vikram_sangeet@yahoo.co.in</b>              </span>
