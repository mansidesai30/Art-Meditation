...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Art Meditation  &#8211; Meditation</title>
...
<li id="1775298573-menu-item-3264" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3253 current_page_item active no-mega-menu" ><a href="p-gallery.php" class=""><i class="fa fa-picture-o"></i> <b> PHOTO GALLERY </b></a></li>
  ...
  <div class="container">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="menu-main-container"><ul id="mobile-nav" class="menu"><li id="menu-item-2923" class="menu-item menu-item-type-post_type menu-item-object-page  no-mega-menu "><a href="index.php" class=""><i class="fa fa-home"></i><b> HOME </b></a>
...
<!--<ul class="sub-menu">
 ...
 <li id="menu-item-3202" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3202"><a href="events.php" class=""><i class="fa fa-music"></i><b> EVENTS </b></a></li>
   <li id="menu-item-3203" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3253 current_page_item active no-mega-menu"><a href="p-gallery.php" class=""><i class="fa fa-picture-o"></i> <b> PHOTO GALLERY </b></a></li>
...
<div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner"><div class="wpb_wrapper"><h4 class="ttbase-heading ttbase-heading-none text-align-center " style="margin-bottom: 50px;"></h4>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="images1/11.jpg" alt="MR.VIKRAM WHILE PERFORMING" style="width:100%;">
        <div class="carousel-caption">
        </div>
      </div>

      <div class="item">
        <img src="images1/12.jpg" alt="" style="width:100%;">
        <div class="carousel-caption">
        </div>
      </div>
    
      <div class="item">
        <img src="images1/13.jpg" alt="" style="width:100%;">
        <div class="carousel-caption">
        </div>
      </div>
    </div>
...
<div class="wpb_column vc_column_container vc_col-sm-24"><div class="vc_column-inner"><div class="wpb_wrapper"><h4 class="ttbase-heading ttbase-heading-none text-align-center " style="margin-bottom: 50px;"><br></br></h4>
  <div class="wpb_text_column wpb_content_element " >
    <div class="wpb_wrapper">
    </div>
  </div>
