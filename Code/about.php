...
<!-- normal size logo -->
    <div class="logo-wrapper">
        <a href="index.php" id="site-logo" title="AM" rel="home">
                            <img src="images/logo.png" alt="Yogax " style=" width: 200px"; srcset="" class="img-responsive"  />
                    </a>
    </div>
                <!-- Menu -->
 ...
 <li id="162979464-menu-item-3257" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3253 current_page_item active no-mega-menu" ><a href="about.php" class=""><i class="fa fa-info"></i><b> ABOUT US </b></a></li>
  ...
  <div class="container">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="menu-main-container"><ul id="mobile-nav" class="menu"><li id="menu-item menu-item-type-post_type menu-item-object-page  no-mega-menu "><a href="index.php" class=""><i class="fa fa-home"></i><b> HOME </b></a>
<li id="menu-item-3257" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3253 current_page_item active no-mega-menu"><a href="about.php" class=""><i class="fa fa-info"></i><b> ABOUT US </b></a></li>
...
p.sansserif {
  ...
  <div class="w3-content w3-container w3-padding-128"><br>
  <p align="center"><p class="blacktext">
  <center><b>ART MEDITATION</b><b><font color=" #C71585"> is something that</font> </b><b>" FOLLOW YOUR HEART "</b></center>
<br>
  <center><p align="justify"><b><font color="black">Follow your heart is just a beatbox for the song of your life. The idea is that to examine the uncovering and working through fears and anxieties related to death and mourning by using an effective tool <b><font color=" #C71585">"MUSIC THERAPY"</font></b>. In this, Examination is done basically on the latency age child and early adolescent at the end stage of life-from time of diagnosis of terminal illness to death. The children presented were seen on a one-to one basis as well as in group therapy. A variety of music therapy techniques such as song writing and selection, lyric substitution, improvisation, and guided imagery are used to encourage the child to release his fears through a creative act. Music provides a medium forgenuine, powerful expression and facilitate a therapeutic relationship which in turn supplies the security and trust that enables the child to let go of his fears.</center></p></font>
 <center> <p align="justify"><font color="black">
    <b>The child/person who is suffering may sometimes be hesitant to voice their concerns to his/her doctors. The bond created by a satisfying relationship by music therapy which is non-medical within the hospital confines to provides a therapeutic vent for frustrating medical experiences.<br></center></font>
      <!--<br><center><font color="black">The patient is then freed to verbalize:</font><b><font color="#C71585"> <br><b>"The medicine's not working, I feel worse," or "There is not much left they can give me.."</b></font></b> <br></center>-->
    <p align="justify"><b><font color="black"><br>Well-staffed hospitals offer a variety of medical and nonmedical professional personnel to promote a child's adjustment to hospitalization and illness.Generally often we are having many training and expertise techniques in the medical education for patients as well as the psychological impact of the child's illness. So better technique is the music therapy.
    </p></p></center></p></b></font>
<!-- <p align="justify"><font color="#C71585"><b><center>"The act of creation is as basic a need as breathing or making love. Making art is a way of concretizing our need to a broader and deeper range of living"  ~ Zinker.</b></p></font></center>
    <center><p class="sansserif"><p align="justify"><b><font color="black">The nature of the music experience inherently provides creative energy that is usually lost in the hospital shuffle. Our music therapy session provides the opportunity for infinite expression in what is a very limited environment. Because of this, he/she expresses a statement of reality and an escape into fantasy. The withdrawn patient who is unable or unwilling to verbalize his thoughts may be able to share the beauty of music listening with another by listening to our session. The listening experience can, in turn, create a bond between patient and therapist that encourages the sharing of thoughts and feelings.</p><b></p></p></center></font>-->
...
<p align="center"><p class="blacktext">
  <center><b><font size="8">Our Promoters</font></b></center></p><br>
<div class="wpb_column vc_column_container vc_col-sm-12">
  <div class="vc_column-inner">
  <div class="wpb_wrapper">
  <div class="ttbase-trainer-grid">
    <div id="1158336921" class="ttbase-trainer-items ttbase-grid clearfix" data-id="1158336921">  
        <div class="term-meditation term-pilates term-yoga ttbase-trainer-item-wrapper ttbase-col ttbase-count-1 ttbase-col-3">
          <div class="ttbase-trainer-item text-center" style="border-color:#e3edf6">
            <a href="" title="" class="ttbase-trainer-item-image">
              <img class="img-responsive" src="images/user.png" alt="Dr. Vikram Parlikar" />
                 <div class="ttbase-trainer-item-image-overlay clearfix" ></div>             
              </a>
            <div class="ttbase-trainer-item-image-content">
              <h5 class="ttbase-trainer-item-subtitle">Meditation Lead</h5>
              <h3 class="ttbase-trainer-item-heading">
                <a href="" title="">Dr. Vikram Parlikar</a>
              </h3>
            </div>
    ...
    <li><a href="http://www.googleplus.com" title="Google+"><i class="sl sl-google-plus"></i></a></li>
          ...
          <p align="justify"><b>As Doctor of Naturopathy, Dr. Vikram Parlikar is disciple of Pandit Ajit Kadkade and Pandit VR Athavale. He his Profound in music and also done an alternative medicine course(MD). A passionate doctor, he is committed to help people by imparting effective treatment for Heart trouble, Diabetes, Cholesterol, Asthma, Thyroid, and Hypertension by Hindustani Ragas and providing clarity in their thinking and ideas.</b></p>
          <div class="read-more-link-wrapper"><a class="read-more-link" href="pramoter.php">read more</a></div>
      </div>        
    </div>
</div>
       
      
        <div class="term-meditation term-pilates ttbase-trainer-item-wrapper ttbase-col ttbase-count-2 ttbase-col-3">
          <div class="ttbase-trainer-item text-center" style="border-color:#e3edf6">
            <a href="" title="Mahesh Dandawate" class="ttbase-trainer-item-image">
                        <img class="img-responsive" alt="Mahesh Dandawate " src="images/user.png" />
                            <div class="ttbase-trainer-item-image-overlay clearfix" ></div></a>
            <div class="ttbase-trainer-item-image-content">
              <h5 class="ttbase-trainer-item-subtitle">Meditation Lead</h5>
              <h3 class="ttbase-trainer-item-heading">
                <a href="" title="">Mahesh Dandawate</a>
              </h3>
            </div>
              <div class="ttbase-trainer-item-content ttbase-trainer-item-excerpt" style="background-color:#ffffff">
                <ul class="ttbase-trainer-item-social"><li>
      <a href="http://www.twitter.com" title="Twitter"><i class="sl sl-twitter"></i></a></li>        
      <li><a href="http://www.facebook.com" title="Facebook"><i class="sl sl-facebook"></i></a></li>
   <li><a href="http://www.googleplus.com" title="Google+"><i class="sl sl-google-plus"></i></a></li>
        ...
        <div class="term-meditation term-pilates term-yoga ttbase-trainer-item-wrapper ttbase-col ttbase-count-3 ttbase-col-3">
          <div class="ttbase-trainer-item text-center" style="border-color:#e3edf6">
            <a href="" title="Sandeep Dandawate" class="ttbase-trainer-item-image">
                                <img class="img-responsive" alt="Sandeep Dandawate" src="images/user.png" />
                              <div class="ttbase-trainer-item-image-overlay clearfix" ></div>             
              </a>
            <div class="ttbase-trainer-item-image-content">
   ...
   <li><a href="http://www.googleplus.com" title="Google+"><i class="sl sl-google-plus"></i></a></li>
              ...
              <p align="justify"><b></b></p>
      <div class="read-more-link-wrapper"><a class="read-more-link" href="pramoter.php" title="">read more</a></div>
            </div>  
          </div>
        </div>
    </div>
