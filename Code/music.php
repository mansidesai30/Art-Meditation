...
<!DOCTYPE html>
<html>
<title>Art Meditation- Learn To Sing</title>
...
<ul class="sub-menu">
  ...
  <ul class="sub-menu">
    <li id="menu-item-3196" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-6 current_page_item menu-item-3196"><a href="music.php" class=""><i class="fa fa-music"></i><b> LEARN TO SING </b></a></li>
...
<div class="bgimg-1 w3-display-container"></div>
   <img src="images/30.jpg" alt="" style="width:100%;height:100%"><a href="" style="text-decoration: none">
  <div class="w3-content w3-container w3-padding-64">
  <p align="center"><p class="blacktext">
  <center><b>WHERE<b></b><b><font color=" #C71585"> words fails</font></b><b> " MUSIC SPEAKS"</b></center>
<br>
  <center><p align="justify"><b><font color="black">"The True beauty of singing is that it connects people. It carries a message, and we the musicians, are the messengers".<b><font color=" #C71585"> "MYTHS"</font></b> about the power of music to regulate and change emotional states are found in each culture. Googling the words ‘‘music and stress’’ produces promises for different types of music specially designed to assist managing stress. Music therapists are familiar with using different techniques to reduce stress with different populations. </center></p></font>
 <center> <p align="justify"><font color="black">
    <b>Since earlier times, music has played an essential part in
human life. Since sounds never lie, music has a truthful authority.
Music has intrigued philosophers and writers who tried to
understand its effect on the human body and on human
emotions.
<br></center></font>
      <br><center><font color="black">The best sayings ever:</font><b><font color="#C71585"> <br><b>"Words make you think a thought. Music makes you feel a feeling. A song makes you feel a thought
".</b></font></b> <br></center>
    <p align="justify"><b><font color="black"><br>
The roots of music can be traced to early infancy.
Trevarten states that ‘‘I believe we see in infants innate
psychological foundations of both musical behaviour and
musical awareness that are unique to human beings’’. In his view, music has strong roots in human nature.

    </p></p></center></p></b></font>
  <p align="justify"><font color="#C71585"><b><center>"MUSIC is the movement of sound to reach the soul for the education of its virtue."</b></p></font></center>
    <center><p class="sansserif"><p align="justify"><b><font color="black">Music is an abstract symbolic language with no specific references or associations. Nevertheless, its intrinsic pattern
and structure convey meaning to our brain. It can act as a powerful sensory stimulus, engaging
the brain in retraining neural and behavioural functions that
can be applied to non-musical context in everyday life, such
as therapeutic needs. Musical meaning was a source of
debate between two main attitudes: the ‘‘absolutes’’ and the
‘‘referentialists’’. Music reaches and
touches us weather we like it or not.</p><b></p></p></center></font>
  </div>
